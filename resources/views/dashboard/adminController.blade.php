...
<head>
    ...
    <title>TQMP | Admin Controller</title>
            ...
            <div class="mt-4">
                ...
                <ul class="nav nav-tabs border-0 mb-3" id="adminTab" role="tablist">
                    <li class="nav-item" role="presentation">
                        <a class="nav-link active" id="tab-all" href="#all" data-bs-toggle="tab" role="tab">All</a>
                    </li>
                    <li class="nav-item" role="presentation">
                        <a class="nav-link text-muted" id="tab-1" href="#pane1" data-bs-toggle="tab" role="tab">Tab 1</a>
                    </li>
                    <li class="nav-item" role="presentation">
                        <a class="nav-link text-muted" id="tab-2" href="#pane2" data-bs-toggle="tab" role="tab">Tab 2</a>
                    </li>
                    <li class="nav-item" role="presentation">
                        <a class="nav-link text-muted" id="tab-3" href="#pane3" data-bs-toggle="tab" role="tab">Tab 3</a>
                    </li>
                </ul>

                <div class="tab-content" id="adminTabContent">
                    <div class="tab-pane show active" id="all" role="tabpanel" aria-labelledby="tab-all">
                        @include('plus.add_adminpage1')
                        @include('plus.add_adminpage2')
                        @include('plus.add_adminpage3')
                    </div>
                    <div class="tab-pane" id="pane1" role="tabpanel" aria-labelledby="tab-1">
                        @include('plus.add_adminpage1')
                    </div>
                    <div class="tab-pane" id="pane2" role="tabpanel" aria-labelledby="tab-2">
                        @include('plus.add_adminpage2')
                    </div>
                    <div class="tab-pane" id="pane3" role="tabpanel" aria-labelledby="tab-3">
                        @include('plus.add_adminpage3')
                    </div>
                </div>
