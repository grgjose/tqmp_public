<div class="row g-4 mt-3">
    ...
    @foreach($settings as $setting)
        ...
        @if(str_starts_with($setting->key, 'CONTACT_'))
                        ...
                        <div class="card-body">
                            <div class="input-group mb-3">
                                <div class="bg-light rounded w-100 mb-3 d-flex align-items-center justify-content-center"
                                    style="height: 120px; background: url('storage/contact/{{ $setting->value }}') no-repeat center center; background-size: contain;">
