...
<body>
    ...
    <section>
        ...
        <div class="container py-5">
            ...
            <form action="/profile-save-shipping" method="POST" id="shippingForm" class="needs-validation" novalidate>
                @csrf
                        ...
                        <div class="row g-3">
                            <div class="col-md-12">
                                ...
                                <input type="text" name="fullname" class="form-control form-control-lg"
                                    ...
                                    value="{{ $my_user->fname.' '.$my_user->mname.' '.$my_user->lname }}" required>
                            </div>
                            <div class="col-md-12">
                                <label class="form-label fw-medium">Full Address</label>
                                <input type="text" name="fulladdress" class="form-control form-control-lg"
                                    placeholder="B2 L3 Sunshine Village, Brgy. Happy, City of Dreams, Country"
                                    value="{{ $my_user->address }}" required>
                            </div>
                            <div class="col-md-6">
                                <label class="form-label fw-medium">Email <span class="text-danger">*</span></label>
                                <input type="email" name="email" value="{{ $my_user->email }}"
                                    class="form-control form-control-lg" placeholder="your@email.com" required>
                            </div>
                            <div class="col-md-6">
                                <label class="form-label fw-medium">Contact Number</label>
                                <input type="tel" name="contact_num" id="contact_number"
                                    value="{{ $my_user->contact_num }}"
                                    class="form-control form-control-lg" placeholder="0912 345 6789" required>
                            </div>
                            <div class="col-12">
