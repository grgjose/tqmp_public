...
// Route::get('/profile-set-shipping', [HomeController::class, 'setShippingProfile'])->middleware(UserAuth::class);

// Route::post('/save-profile', [HomeController::class, 'saveProfile'])->middleware(UserAuth::class);
// Route::post('/confirm-password', [UserController::class, 'confirmPassword'])->middleware(UserAuth::class)->name('confirm.password');
// Route::post('/confirm-username', [UserController::class, 'confirmUsername'])->middleware(UserAuth::class)->name('confirm.username');
// Route::post('/profile-save-shipping', [HomeController::class, 'saveShipping'])->middleware(UserAuth::class);

// Route::get('/add-to-cart/{id}', [ProductController::class, 'before_add_to_cart'])->middleware(UserAuth::class, CheckNotification::class);;
// Route::post('/add-to-cart/{id}', [ProductController::class, 'after_add_to_cart'])->middleware(UserAuth::class, CheckNotification::class);;
// Route::get('/cart', [ProductController::class, 'cart'])->middleware(UserAuth::class, CheckNotification::class);;
...
// Route::get('/show-quotation/{reference}', [QuotationController::class, 'showQuotation'])->middleware(UserAuth::class, CheckNotification::class);
...
// Route::get('/set-shipping', [OrderController::class, 'setShipping'])->middleware(UserAuth::class);
// Route::post('/save-shipping', [OrderController::class, 'saveShipping'])->middleware(UserAuth::class);
...
// Route::get('/show-quotation-messages/{reference}', [QuotationController::class, 'showQuotationMessages'])->middleware(UserAuth::class, CheckNotification::class);
// // Route::get('/status', [HomeController::class, 'status']);
// // Route::get('/Orderstatus', [HomeController::class, 'OrderStatus']);
// Route::get('/quotes-status', [HomeController::class, 'QuoteStatus'])->middleware(UserAuth::class, CheckNotification::class);
// Route::get('/order-status', [HomeController::class, 'OrderStatus'])->middleware(UserAuth::class, CheckNotification::class);
...
// Route::post('/checkout', [ProductController::class, 'checkout'])->middleware(UserAuth::class);
// Route::get('/order-status/{reference}', [ProductController::class, 'order_status'])->middleware(UserAuth::class, CheckNotification::class);
...
// Route::post('/quotation/update-status', [QuotationController::class, 'updateStatus'])
//     ->name('quotation.updateStatus');
...
// Route::get('/apply-discount/{id}', [UserController::class, 'applyDiscount'])->middleware(SalesAuth::class);
// Route::get('/remove-discount/{id}', [UserController::class, 'removeDiscount'])->middleware(SalesAuth::class);
...
// // Dashboard - Settings - Homepage Settings
// Route::get('/admin-control', [AdminController::class, 'index'])->middleware(AdminAuth::class);
// Route::get('/admin-control/tab/{name}', [AdminController::class, 'loadTab'])->name('admin-controller.loadTab');
// Route::post('/admin-control/update/{id}', [AdminController::class, 'update'])->middleware(AdminAuth::class);
...
//API Calls
// Route::post('/lalamoveGetQuotation', [OrderController::class, 'lalamoveGetQuotation'])->middleware(AllUserAuth::class)->name('lalamove.getQuotation');
...
//Admin Controller
// Route::get('/adminController', [AdminController::class, 'adminController'])->middleware(AdminAuth::class);
// Route::get('/auditTrail', [AdminController::class, 'auditTrail'])->middleware(AdminAuth::class);




//UserAuth & CheckNotification Middleware
Route::get('/show-quotation-messages/{reference}', [QuotationController::class, 'showQuotationMessages'])->middleware(UserAuth::class, CheckNotification::class);
Route::get('/quotes-status', [HomeController::class, 'QuoteStatus'])->middleware(UserAuth::class, CheckNotification::class);
Route::get('/order-status', [HomeController::class, 'OrderStatus'])->middleware(UserAuth::class, CheckNotification::class);
Route::get('/add-to-cart/{id}', [ProductController::class, 'before_add_to_cart'])->middleware(UserAuth::class, CheckNotification::class);;
...
/*
|--------------------------------------------------------------------------
| User Protected Routes (UserAuth)
|--------------------------------------------------------------------------
*/
...
/*
|--------------------------------------------------------------------------
| Sales Protected Routes (SalesAuth)
|--------------------------------------------------------------------------
*/
...
/*
|--------------------------------------------------------------------------
| Admin Protected Routes (AdminAuth)
|--------------------------------------------------------------------------
*/
...
/*
|--------------------------------------------------------------------------
| All User Protected Routes (AllUserAuth)
|--------------------------------------------------------------------------
*/
